<div class="card card-4">
    <div class="card-body">
        <h2 class="text"><?= $title; ?></h2>
            <span style="color: #0086b3"> Welcome <?php echo $this->session->userdata('email') ;?></span></header><br /><br />
            <div class="row">
                            ...
                            <div class="col-sm-4 col-md-4 text-danger">
                                ...
                                <?php if( $task > 0)
                                    ...
                                    <?php }
                                        ...
                                        echo 'You have not completed any tasks. Visit todo and complete your remaning tasks. ';
                                    }
                                ?>                                    
                                </div>
            </div>
